...
export default function Projects() {
  ...
  return (
  <main onMouseMove={(e) => {moveItems(e.clientX, e.clientY)}} className="projectsmain">
    <div className="projectsbody">
      {
        projects.map( (project, index) => {
          return <DemoProject index={index} title={project.title} manageModal={manageModal} key={index}/>
        })
      }
    </div>
    <Rounded>
